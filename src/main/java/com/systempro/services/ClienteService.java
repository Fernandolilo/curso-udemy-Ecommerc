...
public class ClienteService {
	...
	public Cliente update(Cliente obj) {
		...
		// feito um tratamento de dados a baixo em updateDatam setando novo nome e novo
		// email.
	...
	// metodo criado para atualizar campos nome e email do cliente, que é a unica
	// coisa que permitimos atualizar.
